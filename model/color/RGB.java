...
public class RGB extends CIExyz{
  ...
  {0.0556434,-0.2040259,1.0572252}}; //contains matrix to transforma CIExyz color rappresentation to sRGB
  private static double[][] RGB_CIE = new double[][]{{0.4124564, 0.3575761, 0.1804375},
  {0.2126729, 0.7151522, 0.0721750},
  {0.0193339, 0.1191920, 0.9503041}};//contains matrix to transforma sRGB color rappresentation to CIExyz
